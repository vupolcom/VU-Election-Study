Data Cleaning: Dutch Parliamentary Elections 2021 Pre-Wave
================
...
Jansen, Nicolas Matthis, Kasper Welbers and Nienke Wolfers
...
# Scripts
  ...
  - [Recode Block C Issue
    Association](#recode-block-c-issue-association)
  - [Recode Block D Political
    Knowledge](#recode-block-d-political-knowledge)
  - [Recode Block E Political
    Background](#recode-block-e-political-background)
  - [Recode Block F Trust](#recode-block-f-trust)
  - [Recode Block G Evaluation of Government and Political
    Leaders](#recode-block-g-evaluation-of-government-and-political-leaders)
...
``` r
f <- "VU+VerkiezingsPanel+-+Voormeting_January+29,+2021_09.52.csv"
  ...
  mutate(gender = recode(gender, `2` = 0),
         ...
         ethnicity = ifelse(country_birth==1 & country_father==1 & 
                    ...
                    ifelse(country_birth==13, 2,
                           999)))))))))))))))))))))))))))))))) %>%
  select(wave,start_date, end_date, duration_min, iisID, gender, 
...
C1_1 <- d %>%
  ...
  pivot_longer(cols = X1_C1_1_2:X13_C1_1_4,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C1_1", C1_1_2:C1_1_4, remove = T, na.rm = T) %>%
  mutate(C1_1 = ifelse(C1_1 == "", "999", C1_1),
         C1_1 = as.numeric(C1_1),
         C1_1 = recode(C1_1,
                       `20` = 1,`21` = 2, `22` = 3, `23` = 4,
                       `24` = 5,`25` = 6, `26` = 7, `27` = 8,
...
C1_1 <- C1_1 %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C1_1) %>%
  select(iisID, C1_1_1 = X1,
         C1_1_2 = X1, C1_1_3 = X3, C1_1_4 = X4, C1_1_5 = X5,
         C1_1_6 = X6, C1_1_7 = X7, C1_1_8 = X1, C1_1_9 = X9,
         C1_1_10 = X10, C1_1_11 = X11, C1_1_12 = X12, C1_1_13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
C1_1_txt <- d %>%
  ...
  pivot_longer(cols = X1_C1_1_2_38_TEXT:X13_C1_1_4_38_TEXT,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C1_1_txt", C1_1_2_38_TEXT:C1_1_4_38_TEXT, remove = T, na.rm = T) %>%
  mutate(C1_1_txt = ifelse(C1_1_txt == "", "None", C1_1_txt))

C1_1_txt <- C1_1_txt %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C1_1_txt) %>%
  select(iisID, C1_1_txt1 = X1,
         C1_1_txt2 = X1, C1_1_txt3 = X3, C1_1_txt4 = X4, C1_1_txt5 = X5,
         C1_1_txt6 = X6, C1_1_txt7 = X7, C1_1_txt8 = X1, C1_1_txt9 = X9,
         C1_1_txt10 = X10, C1_1_txt11 = X11, C1_1_txt12 = X12, 
         C1_1_txt13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
C1_2 <- d %>%
  ...
  pivot_longer(cols = X1_C1_2_2:X13_C1_2_4,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C1_2", C1_2_2:C1_2_4, remove = T, na.rm = T) %>%
  mutate(C1_2 = ifelse(C1_2 == "", "999", C1_2),
         C1_2 = as.numeric(C1_2),
         C1_2 = recode(C1_2,
                       `20` = 1,`21` = 2, `22` = 3, `23` = 4,
                       `24` = 5,`25` = 6, `26` = 7, `27` = 8,
                       `28` = 9,`29` = 10, `30` = 11, `31` = 12,
...
C1_2 <- C1_2 %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C1_2) %>%
  select(iisID, C1_2_1 = X1,
         C1_2_2 = X1, C1_2_3 = X3, C1_2_4 = X4, C1_2_5 = X5,
         C1_2_6 = X6, C1_2_7 = X7, C1_2_8 = X1, C1_2_9 = X9,
         C1_2_10 = X10, C1_2_11 = X11, C1_2_12 = X12, C1_2_13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
C1_2_txt <- d %>%
  ...
  pivot_longer(cols = X1_C1_2_2_38_TEXT:X13_C1_2_4_38_TEXT,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C1_2_txt", C1_2_2_38_TEXT:C1_2_4_38_TEXT, remove = T, na.rm = T) %>%
  mutate(C1_2_txt = ifelse(C1_2_txt == "", "None", C1_2_txt))

C1_2_txt <- C1_2_txt %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C1_2_txt) %>%
  select(iisID, C1_2_txt1 = X1,
         C1_2_txt2 = X1, C1_2_txt3 = X3, C1_2_txt4 = X4, C1_2_txt5 = X5,
         C1_2_txt6 = X6, C1_2_txt7 = X7, C1_2_txt8 = X1, C1_2_txt9 = X9,
         C1_2_txt10 = X10, C1_2_txt11 = X11, C1_2_txt12 = X12, 
         C1_2_txt13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
C2_1 <- d %>%
  ...
  pivot_longer(cols = X1_C2_1_2:X13_C2_1_4,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C2_1", C2_1_2:C2_1_4, remove = T, na.rm = T) %>%
  mutate(C2_1 = ifelse(C2_1 == "", "999", C2_1),
         C2_1 = as.numeric(C2_1)) 

C2_1 <- C2_1 %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C2_1) %>%
  select(iisID, C2_1_1 = X1,
         C2_1_2 = X1, C2_1_3 = X3, C2_1_4 = X4, C2_1_5 = X5,
         C2_1_6 = X6, C2_1_7 = X7, C2_1_8 = X1, C2_1_9 = X9,
         C2_1_10 = X10, C2_1_11 = X11, C2_1_12 = X12, C2_1_13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
C2_2 <- d %>%
  ...
  pivot_longer(cols = X1_C2_2_2:X13_C2_2_4,
               names_to = "variable") %>%
  separate(variable, c("variable", "question"), "_", extra = "merge")   %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = question, values_from = value) %>%
  unite("C2_2", C2_2_2:C2_2_4, remove = T, na.rm = T) %>%
  mutate(C2_2 = ifelse(C2_2 == "", "999", C2_2),
         C2_2 = as.numeric(C2_2)) 

C2_2 <- C2_2 %>%
  group_by(variable) %>%
  mutate(row = row_number()) %>%
  pivot_wider(names_from = variable, values_from = C2_2) %>%
  select(iisID, C2_2_1 = X1,
         C2_2_2 = X1, C2_2_3 = X3, C2_2_4 = X4, C2_2_5 = X5,
         C2_2_6 = X6, C2_2_7 = X7, C2_2_8 = X1, C2_2_9 = X9,
         C2_2_10 = X10, C2_2_11 = X11, C2_2_12 = X12, C2_2_13 = X13) %>%
  distinct(iisID, .keep_all = TRUE)
...
I <- d %>%
  ...
  select(iisID, I1_1:I1_9, I2_1:I2_13, I2_other = I2_13_TEXT,
         ...
         I7_1:I7_11, I7_other = I7_10_TEXT,
