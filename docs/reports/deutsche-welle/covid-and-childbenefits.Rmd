...
```{r "Child-Benefits-Party", fig.height=10, fig.width=10, fig.cap="Should the Cabinet Fall over the Child Benefits Scandal?"}
d %>%
...
```{r "Child-Benefits-Rutte", fig.height=10, fig.width=10, fig.cap="Should the Cabinet Fall over the Child Benefits Scandal?"}
d %>%
  mutate(G1_b = ifelse(G1_b < 4, "Yes: Government had to step down",
                ifelse(G1_b > 3 & G1_b <7, "Neutral",
                ifelse(G1_b > 6 & G1_b < 11, "No: Government shouldn't have fallen",
