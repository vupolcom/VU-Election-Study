...
```{r "vaccinatiebereidheid", fig.height=10, fig.width=10, fig.cap="Figuur Vaccinatiebereidheid"}
...
```{r "vaccinatiebereidheid2", fig.height=10, fig.width=10, fig.cap="Figuur Vaccinatiebereidheid"}
w0 <- read_csv(here("data/intermediate/VUElectionPanel2021_wave0.csv")) %>%
